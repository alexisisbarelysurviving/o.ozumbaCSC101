...
fn main() {
    ...
    if profession == "office_administrator" && (years_of_expirience == 1 || years_of_expirience == 2){
        ...
        println!("User is a Office manager");
        ...
        println!("User is a Director"); //i do not know how the put in SES as an expirience type since its a string 
        ...
        println!("User is an Research assistant");
        ...
        println!("User is an Leading Teacher");
